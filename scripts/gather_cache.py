# '''
# Code for Improved Precision and Recall Metric for Assessing Generative Models

# Source: https://github.com/youngjung/improved-precision-and-recall-metric-pytorch
...
#             self.vgg16 = models.vgg16(weights=models.VGG16_Weights.DEFAULT).eval()
#             print('done')
#         else:
#             self.vgg16 = model
...
#     #     print(desc)
#     #     first_image = next(iter(dataloader))
