...
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/no_linear_clip_l2_unit/log_out.log
...
export EXP_NAME=no_linear_clip_l2_unit
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --wandb_name no_linear_clip_l2_unit \
    --force_factor 0.01 \
