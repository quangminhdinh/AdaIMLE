...
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/clip0_1_concat_rep_gain_multires/log_out.log
...
export EXP_NAME=clip0_1_concat_rep_gain_multires
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --wandb_name clip0_1_concat_rep_gain_multires \
    --force_factor 0.01 \
