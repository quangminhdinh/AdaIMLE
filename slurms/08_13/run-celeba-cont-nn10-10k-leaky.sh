...
#SBATCH --gres=gpu:h100:2 # 32G V100
#SBATCH --output=/scratch/qmd/results/new_imle/celeba/celeba_from_uncond_nn10_10k_leaky/log_out.log
...
export EXP_NAME=celeba_from_uncond_nn10_10k_leaky
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --dataset celeba \
    --wandb_name celeba_from_uncond_nn10_10k_leaky \
    --force_factor 0.002 \
