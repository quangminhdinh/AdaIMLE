...
#SBATCH --output=/scratch/qmd/results/new_imle/celeba/celeba_freeze_nn5_10k/log_out.log
...
export EXP_NAME=celeba_freeze_nn5_10k
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --dataset celeba \
    --wandb_name celeba_freeze_nn5_10k \
    --force_factor 0.002 \
