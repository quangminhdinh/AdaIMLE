...
#SBATCH --exclude=cdr2482,cdr2486,cdr2614,cdr2591,cdr2513
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/proj_32_sg_0_5/log_out.log
...
export EXP_NAME=proj_32_sg_0_5
