...
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/pretrained/log_out.log
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --load_strict 0 \
    --restore_path /scratch/qmd/results/new_imle/flowers_t/unconditional_2/train/${load_point}-model.th \
    --restore_ema_path /scratch/qmd/results/new_imle/flowers_t/unconditional_2/train/${load_point}-model-ema.th \
    # --restore_optimizer_path /scratch/qmd/results/new_imle/flowers_t/unconditional_2/train/${load_point}-opt.th \
    # --restore_scaler_path /scratch/qmd/results/new_imle/flowers_t/unconditional_2/train/${load_point}-scaler.th \
    # --restore_scheduler_path /scratch/qmd/results/new_imle/flowers_t/unconditional_2/train/${load_point}-sched.th \
