...
#SBATCH --output=/scratch/qmd/results/new_imle/celeba/celeba_cfg_0_5_nn10_10k/log_out.log
...
export EXP_NAME=celeba_cfg_0_5_nn10_10k
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --dataset celeba \
    --wandb_name celeba_cfg_0_5_nn10_10k \
    --force_factor 0.002 \
