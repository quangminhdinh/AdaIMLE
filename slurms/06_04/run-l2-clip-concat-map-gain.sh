...
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/l2_clip_concat_map_gain/log_out.log
...
export EXP_NAME=l2_clip_concat_map_gain
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --wandb_name l2_clip_concat_map_gain \
    --force_factor 0.01 \
