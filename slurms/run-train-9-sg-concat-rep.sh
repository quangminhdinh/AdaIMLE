...
#SBATCH --output=/scratch/qmd/results/new_imle/flowers_t/sg_9_force_2_concat_rep/log_out.log
...
export EXP_NAME=sg_9_force_2_concat_rep
...
exec torchrun --nproc_per_node=$(echo $CUDA_VISIBLE_DEVICES | awk -F',' '{print NF}') --standalone train.py --hps fewshot \
    ...
    --wandb_name sg_9_force_2_concat_rep \
    --force_factor 0.01 \
